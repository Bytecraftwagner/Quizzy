...
import Banner from "../assets/Images/bghome.svg"
    ...
    <div className='mt-9'>
      ...
      text-white justify-between'>
        ...
        <div className=' drop-shadow-2xl w-[499px]  my-8 relative max-sm:w-[300px] '>
            ...
            <img src={Banner} alt="banner" className=' absolute top-4 right-[49px]   w-[400px] -z-10 max-sm:w-[230px] max-sm:top-3 max-sm:right-[35px]' />
        </div>
